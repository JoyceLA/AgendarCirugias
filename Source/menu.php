...
?>
	...
	<body >	<!--DESHABILITANDO EL BOTON IZQUIERDO PARA LAS OPCIONES   oncontextmenu="return false" onkeydown="return false"-->
		<diV id="contenedorMain">	
			...
			<div id="header">
				<br/>
				&nbsp;&nbsp;&nbsp;&nbsp;<img id="tareas" title="" src="img/tareas.PNG" >
				 &nbsp;&nbsp;&nbsp;&nbsp;
				<label id="welcome">BIENVENID@</label>
			...
			<label id="user"><?php echo  "  Usuario.  ".$id; ?> </label>
		...
		<div id="contenedor">
			<div class="buttons">
				<?php
					...
					elseif ($username == "cirboss") {
						echo '
							  <input name="seeWinAdmiAgenda" class="boton" type="button" value="ADMINISTRAR AGENDA" onClick="seeWinAdminAgenda(\'form_adminAgenda\');" target="_self" id="seeWinAdmiAgenda"/>
						...
						echo '
							...
							<input name="seeWinVerAgenda" class="boton" type="button" value="MI AGENDA" onClick="seeWinVerAgendado(\'form_verMiAgenda\');" target="_self" id="seeWinVerAgenda"/>
							';
					}
					echo "<br/><br/>";
				?>
			...
			<center>
				<div class="formulario">
					<iframe id="form_agenda" scrolling="auto" src="agendarcirugia.php" frameborder="0" height="700" width="700"></iframe>	
					<iframe id="form_registro" scrolling="auto" src="registrar.php" frameborder="0" height="260" width="700"></iframe>
					<iframe id="form_desbloquea" scrolling="auto" src="desbloquearcuenta.php" frameborder="0" height="700" width="800"></iframe>
					<iframe id="form_adminhorarios" scrolling="auto" src="administrahorario.php" frameborder="0" height="310" width="710"></iframe>
					<iframe id="form_verMiAgenda" scrolling="auto" src="veragenda.php" frameborder="0" height="700" width="850"></iframe>
					<iframe id="form_adminAgenda" scrolling="auto" src="administraquirofano.php" frameborder="0" height="700" width="850"></iframe>
